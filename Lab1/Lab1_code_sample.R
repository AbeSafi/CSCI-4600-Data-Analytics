...
boxplot(TCG, AGR, names = c("TCG","AGR"))

# Histogram 1
x <- seq(0, 90, 5)
hist(TCG, x, prob=TRUE)
...
# ECDFs
plot(ecdf(TCG), do.points=FALSE, verticals=TRUE) 
plot(ecdf(AGR), do.points=TRUE, verticals=FALSE) 
...
qqplot(TCG, AGR, xlab = "Q-Q plot for AGR vs TCG") 
